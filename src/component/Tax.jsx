...
const Tax = () => {
  ...
  useEffect(() => {
    ...
    console.log("🚀 ~ file: Tax.jsx:30 ~ useEffect ~ sectionNameMap:", sectionNameMap)
    data.forEach((item) => {
    ...
    const uniqueModes = Array.from(sectionNameMap).map(
      ([name, values]) => {
          ...
          <div className=" ">
            <div className="Frame65    grow flex-col justify-start items-start inline-flex">
              <div className="Frame56  grow self-stretch h-11 justify-start items-start inline-flex">
                <div className="Frame53 grow  w-[248px] self-stretch px-5 py-2 border-gray-300 bg-neutral-900 border-r border-transparent border-opacity-20 justify-start items-center gap-2.5 flex">
                  <div className="BillNo grow w-80  text-stone-50 border-transparent text-xs font-normal">
                    Branch Name
                  </div>
                </div>

                <div className="Frame54 grow  w-32 self-stretch px-9 py-2 border-gray-500 bg-neutral-900 border-r border-transparent  border-opacity-20 justify-center items-center gap-2.5 flex flex-col">
                  {/* <div className="Amount grow text-stone-50 text-xs border-transparent border-r border-gray font-normal">
                    Tax 5%
                  </div> */}
                  <div className="Amount grow text-stone-50 text-xs border-transparent font-normal flex gap-[100px]">
                    <div className="Amount grow text-stone-50 text-xs border-transparent font-normal text-center">
                      Amount
                    </div>
