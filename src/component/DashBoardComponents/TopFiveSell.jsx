...
const TopFiveSell = () => {
  ...
  const topFiveData = [
    ...
    { name: 'beef bicol kare', color: 'fuchsia-700', percentage: '60%', amount: '38.45 AED' },
    { name: 'chicken kare kea', color: 'orange-500', percentage: '30%', amount: '30 AED' },
    { name: 'specoial beef bulao', color: 'sky-500', percentage: '63%', amount: '43.3 AED' },
  ...
  return (
    ...
    >
      ...
      {/* Dynamic Rendering based on topFiveData */}
      {topFiveData.map((data, index) => (
        <div key={index} className="Frame219 py-1.5 self-stretch justify-start items-start inline-flex">
          ...
          <div className="flex">
            <div className={`Frame217 grow shrink basis-0 w-[207px] justify-start items-start inline-flex`}>
              <div
