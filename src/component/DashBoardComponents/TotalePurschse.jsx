...
const TotalePurschse = () => {
  ...
  return (
    <div
      ...
      className=" w-[138px] px-5 py-2  bg-opacity-95 rounded-xl  flex-col justify-start items-c inline-flex"
    >
      ...
      <div className="h-[23px] justify-start items-end inline-flex">
        <div className="justify-center items-end gap-2.5 flex">
          <div className=" h-[27px] text-purple-700 text-xl font-normal font-['Poppins']">
            322.61
          </div>
        </div>
        <div className="justify-center items-end gap-2.5 flex">
          <div className=" mb-1  text-xs font-normal font-['Poppins']">AED</div>
        </div>
      </div>
      ...
      <div className="h-[23px] justify-start items-end inline-flex">
        <div className="justify-center items-end gap-2.5 flex">
          <div className=" h-[27px] text-fuchsia-600 text-xl font-normal font-['Poppins']">
            322.61
          </div>
        </div>
        <div className="justify-center items-end gap-2.5 flex">
